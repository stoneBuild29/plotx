...
export class plotx extends ethereum.SmartContract {
  static bind(address: Address): plotx {
    return new plotx("plotx", address);
  }

  changeOperator(_newOperator: Address): boolean {
    let result = super.call(
      "changeOperator",
      "changeOperator(address):(bool)",
      [ethereum.Value.fromAddress(_newOperator)],
    );

    return result[0].toBoolean();
  }

  try_changeOperator(_newOperator: Address): ethereum.CallResult<boolean> {
  ...
  lockedForGV(param0: Address): BigInt {
    let result = super.call("lockedForGV", "lockedForGV(address):(uint256)", [
  ...
  try_lockedForGV(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "lockedForGV",
      "lockedForGV(address):(uint256)",
      [ethereum.Value.fromAddress(param0)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  isLockedForGV(_of: Address): boolean {
    let result = super.call("isLockedForGV", "isLockedForGV(address):(bool)", [
  ...
  try_isLockedForGV(_of: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isLockedForGV",
      "isLockedForGV(address):(bool)",
      [ethereum.Value.fromAddress(_of)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class LockForGovernanceVoteCall extends ethereum.Call {
  get inputs(): LockForGovernanceVoteCall__Inputs {
    return new LockForGovernanceVoteCall__Inputs(this);
  }

  get outputs(): LockForGovernanceVoteCall__Outputs {
    return new LockForGovernanceVoteCall__Outputs(this);
  }
}

export class LockForGovernanceVoteCall__Inputs {
  _call: LockForGovernanceVoteCall;

  constructor(call: LockForGovernanceVoteCall) {
    this._call = call;
  }
...
export class LockForGovernanceVoteCall__Outputs {
  _call: LockForGovernanceVoteCall;
...
export class ConstructorCall__Inputs {
  ...
  get _initialTokenHolder(): Address {
    return this._call.inputValues[1].value.toAddress();
  }
}
